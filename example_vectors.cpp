...
int main(int argc, char* argv[])
{
    ...
    // Vector of pointers 
    // Vector of arrays 
    // Pointer to a vector of ints
    // Pointer to a vector of vector of ints

    std::vector<int>    a   =   {1,2,3,4};                                                      // Vector of ints        
    ...
    std::vector<int*>   a7;                         // Vector of pointers to int 
    int     x = 100;
    int*    y = &x; 
    a7.push_back(y);
    ...
    std::vector<std::vector<int>>   b;                                                                  // Vector of vector of ints
    b.push_back(a1);
